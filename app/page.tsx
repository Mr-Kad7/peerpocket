...
export default function Home() {
  ...
  return <main id="top">
    ...
    <section id="learn" className="section light-section page-pad"><div className="section-heading"><div><div className="eyebrow">Learn and grow</div><h2 className="section-title">Learn a skill. Build a trade.</h2></div><p className="section-subtitle">Practical knowledge helps turn a good idea into a stronger business.</p></div><div className="skill-grid"><div className="skill-group"><h3>Business skills</h3><div className="skill-list"><span>Graphic design</span><span>Digital marketing</span><span>Coding</span><span>Photography</span><span>Bookkeeping</span><span>Copywriting</span></div></div><div className="skill-group"><h3>Practical trades</h3><div className="skill-list"><span>Tailoring</span><span>Shoemaking</span><span>Plumbing</span><span>Electrical work</span><span>Welding</span><span>Carpentry</span><span>Hairdressing</span></div></div></div></section>
