...
const learningResources = [
  {name:"Graphic design",group:"Business skills",description:"Create clear flyers, social posts and campaign images.",source:"Canva Design School",sourceUrl:"https://www.canva.com/designschool/",videoUrl:"https://www.youtube.com/results?search_query=graphic+design+for+beginners"},
  {name:"Digital marketing",group:"Business skills",description:"Reach the right customers with simple online campaigns.",source:"Google Digital Garage",sourceUrl:"https://learndigital.withgoogle.com/digitalgarage",videoUrl:"https://www.youtube.com/results?search_query=digital+marketing+for+beginners"},
  {name:"Coding",group:"Business skills",description:"Build useful tools and understand how digital products work.",source:"freeCodeCamp",sourceUrl:"https://www.freecodecamp.org/learn/",videoUrl:"https://www.youtube.com/results?search_query=coding+for+beginners"},
  {name:"Photography",group:"Business skills",description:"Take stronger product photos that help customers decide.",source:"Adobe Photography Basics",sourceUrl:"https://www.adobe.com/creativecloud/photography/discover/photography-basics.html",videoUrl:"https://www.youtube.com/results?search_query=product+photography+for+beginners"},
  {name:"Bookkeeping",group:"Business skills",description:"Track sales, costs and cash so you know how your business is doing.",source:"QuickBooks Accounting Guide",sourceUrl:"https://quickbooks.intuit.com/accounting/",videoUrl:"https://www.youtube.com/results?search_query=bookkeeping+for+small+business+beginners"},
  {name:"Copywriting",group:"Business skills",description:"Write words that explain your offer and invite people to act.",source:"Coursera Copywriting Guide",sourceUrl:"https://www.coursera.org/articles/copywriting",videoUrl:"https://www.youtube.com/results?search_query=copywriting+for+beginners"},
  {name:"Tailoring",group:"Practical trades",description:"Learn measurements, garment construction and finishing skills.",source:"Tailoring Learning Search",sourceUrl:"https://www.youtube.com/results?search_query=tailoring+for+beginners",videoUrl:"https://www.youtube.com/results?search_query=tailoring+for+beginners"},
  {name:"Shoemaking",group:"Practical trades",description:"Explore shoe patterns, cutting, assembly and repair.",source:"Shoemaking Learning Search",sourceUrl:"https://www.youtube.com/results?search_query=shoemaking+for+beginners",videoUrl:"https://www.youtube.com/results?search_query=shoemaking+for+beginners"},
  {name:"Plumbing",group:"Practical trades",description:"Understand fittings, water flow and safe repair basics.",source:"Plumbing Learning Search",sourceUrl:"https://www.youtube.com/results?search_query=plumbing+for+beginners",videoUrl:"https://www.youtube.com/results?search_query=plumbing+for+beginners"},
  {name:"Electrical work",group:"Practical trades",description:"Study circuits, tools and essential electrical safety.",source:"Electrical Learning Search",sourceUrl:"https://www.youtube.com/results?search_query=basic+electrical+work+for+beginners",videoUrl:"https://www.youtube.com/results?search_query=basic+electrical+work+for+beginners"},
  {name:"Welding",group:"Practical trades",description:"Learn equipment basics, joints, materials and workshop safety.",source:"Welding Learning Search",sourceUrl:"https://www.youtube.com/results?search_query=welding+for+beginners",videoUrl:"https://www.youtube.com/results?search_query=welding+for+beginners"},
  {name:"Carpentry",group:"Practical trades",description:"Build confidence with measuring, cutting and joining wood.",source:"Carpentry Learning Search",sourceUrl:"https://www.youtube.com/results?search_query=carpentry+for+beginners",videoUrl:"https://www.youtube.com/results?search_query=carpentry+for+beginners"},
  {name:"Hairdressing",group:"Practical trades",description:"Practice care, styling, hygiene and client service basics.",source:"Hairdressing Learning Search",sourceUrl:"https://www.youtube.com/results?search_query=hairdressing+for+beginners",videoUrl:"https://www.youtube.com/results?search_query=hairdressing+for+beginners"}
];
...
export default function Home() {
  ...
  return <main id="top">
    <header className="nav">
      ...
      <div className="nav-actions"><a className="learn-nav-link" href="#learn">Learn a skill</a><button className="pitch-btn" onClick={() => setModal("pitch")}>Pitch your business</button></div>
    </header>
    ...
    <section id="learn" className="section light-section page-pad"><div className="section-heading"><div><div className="eyebrow">Learn and grow</div><h2 className="section-title">Learn a skill. Build a trade.</h2></div><p className="section-subtitle">Practical knowledge helps turn a good idea into a stronger business. Each resource opens in a new tab.</p></div><div className="learning-grid">{learningResources.map(resource=><article className="learning-card" key={resource.name}><div className="learning-card-top"><span className="learning-group">{resource.group}</span><h3>{resource.name}</h3></div><p>{resource.description}</p><div className="learning-links"><a href={resource.sourceUrl} target="_blank" rel="noreferrer">Read resource <span>↗</span></a><a href={resource.videoUrl} target="_blank" rel="noreferrer">Watch videos <span>↗</span></a></div></article>)}</div></section>
